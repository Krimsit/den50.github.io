...
function r(a){/in/.test(document.readyState)?setTimeout("r("+a+")",9):a()}$(function(){function a(){s=new ymaps.Map("map",{center:[55.648875, 49.201599],zoom:16}),s.controls.remove("routeEditor").remove("trafficControl").remove("searchControl").remove("fullscreenControl").remove("rulerControl"),s.behaviors.disable(["scrollZoom"]),myCollection=new ymaps.GeoObjectCollection({},{preset:"islands#orangeHomeIcon",draggable:!1}),c=new ymaps.Placemark([55.648875, 49.201599],{balloonContentHeader:'<img src="img/logo.png" alt="мебель дизайн" class="map__pic"> <span class="map__decr">Мебель дизайн 21</span>',balloonContentBody:"Изготовление мебели на заказ в Казани",balloonContentFooter:"г. Казань, Лесхозовская 32",hintContent:"г. Казань, Лесхозовская 32"}),myCollection.add(c),s.geoObjects.add(myCollection),c.balloon.open()}$(window).resize(function(){$(window).width()>768?($(".portfolio__tabs-list").show(),$(".portfolio__tabs-link").click(function(a){$(".portfolio__tabs-list").show()})):($(".portfolio__tabs-list").hide(),$(".portfolio__mob").click(function(a){$(".portfolio__tabs-list").show()}),$(".portfolio__tabs-link").click(function(a){$(".portfolio__tabs-list").hide()}))});var e=$(".hamburger"),i=$(".menu__slide"),t=$(".menu__close"),l=$(".menu__slide a");e.click(function(a){i.toggleClass("menu_active")}),t.click(function(a){i.removeClass("menu_active")}),l.click(function(a){i.removeClass("menu_active")}),jQuery("a.scrollto").click(function(){return elementClick=jQuery(this).attr("href"),destination=jQuery(elementClick).offset().top,jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},1100),!1}),$(".vertikal__container").slick({slidesToShow:1,dots:!0,autoplay:!0,autoplaySpeed:2e3,speed:900,infinite:!0,fade:!0,cssEase:"linear"});var o=$("#sl1"),n=o.parent();o.sly({horizontal:1,itemNav:"basic",activateMiddle:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl2"),n=o.parent();o.sly({horizontal:1,itemNav:"basic",activateMiddle:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl3"),n=o.parent();o.sly({horizontal:1,itemNav:"basic",activateMiddle:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl4"),n=o.parent();o.sly({horizontal:1,activateMiddle:1,activateOn:"click",itemNav:"basic",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl5"),n=o.parent();o.sly({horizontal:1,activateMiddle:1,activateOn:"click",itemNav:"basic",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl6"),n=o.parent();o.sly({horizontal:1,activateMiddle:1,activateOn:"click",itemNav:"basic",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl7"),n=o.parent();o.sly({horizontal:1,itemNav:"basic",activateMiddle:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl8"),n=o.parent();o.sly({horizontal:1,activateMiddle:1,activateOn:"click",itemNav:"basic",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init();var o=$("#sl9"),n=o.parent();o.sly({horizontal:1,activateMiddle:1,activateOn:"click",itemNav:"basic",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:n.find(".scrollbar"),syncSpeed:1,scrollBy:1,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,dynamicHandle:0,clickBar:1}).init(),$(".slider__tabs").not(":first").hide(),$(".portfolio__tabs-list li").click(function(){$(".portfolio__tabs-list li").removeClass("active").eq($(this).index()).addClass("active"),$(".slider__tabs").hide().eq($(this).index()).fadeIn(),$(".frame").sly("reload"),$("#sl9").sly("reload"),$("#sl8").sly("reload"),$("#sl7").sly("reload"),$("#sl6").sly("reload"),$("#sl5").sly("reload"),$("#sl4").sly("reload"),$("#sl3").sly("reload"),$("#sl2").sly("reload"),$("#sl1").sly("reload")}).eq(0).addClass("active"),$(".kitchen-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".detmebel-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".krovati-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".vanna-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".torg-bar-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".office-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".stenki-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".stoli-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".cupe-img").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".popup-youtube").magnificPopup({type:"iframe",iframe:{patterns:{youtube:{index:"youtube.com/",id:"v=",src:"//www.youtube.com/embed/%id%?autoplay=1&rel=0&showinfo=0&controls=1"}}}}),$(".box__item").not(":first").hide(),$(".techo__tab").click(function(){$(".techo__tab").removeClass("active").eq($(this).index()).addClass("active"),$(".box__item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".comments__box-video").not(":first").hide(),$(".comments__item").click(function(){$(".comments__item").removeClass("active").eq($(this).index()).addClass("active"),$(".comments__box-video").hide().eq($(this).index()).fadeIn(),$("iframe").stopVideo()}).eq(0).addClass("active"),$("a").click(function(){$("#"+$(this).data("modal")).css("display","block")}),$("a").click(function(){$("#"+$(this).data("modal2")).css("display","block")}),$("a").click(function(){$("#"+$(this).data("modal3")).css("display","block")}),$("a").click(function(){$("#"+$(this).data("modal4")).css("display","block")}),$("a[data-remodal-target=modal2], a[data-remodal-target=modal3], a[data-remodal-target=modal4]").click(function(){var a=$(this).data("form");$(".form-callback [name=admin-data]").val(a)}),$("select").selectize({create:!1}),$("form").submit(function(){var a=$(this);return $.ajax({type:"POST",url:"mail.php",data:a.serialize()}).done(function(){$(".remodal .success").addClass("active"),setTimeout(function(){$(".remodal .success").removeClass("active"),a.trigger("reset"),$(".remodal-close").click()},3e3)}),!1}),ymaps.ready(a);var s,c}),r(function(){if(document.getElementsByClassName)var a=document.getElementsByClassName("youtube");else var a=function(a,e){for(var i=[],t=new RegExp("(^| )"+e+"( |$)"),l=a.getElementsByTagName("*"),o=0,n=l.length;o<n;o++)t.test(l[o].className)&&i.push(l[o]);return i}(document.body,"youtube");for(var e=a.length,i=0;i<e;i++){a[i].style.backgroundImage="url(http://i.ytimg.com/vi/"+a[i].id+"/maxresdefault.jpg)";var t=document.createElement("div");t.setAttribute("class","play"),a[i].appendChild(t),a[i].onclick=function(){var a=document.createElement("iframe"),e="https://www.youtube.com/embed/"+this.id+"?autoplay=1&autohide=1&rel=0&showinfo=0&controls=1&enablejsapi=1";this.getAttribute("data-params")&&(e+="&"+this.getAttribute("data-params")),a.setAttribute("src",e),a.setAttribute("frameborder","0"),a.style.width=this.style.width,a.style.height=this.style.height,this.parentNode.replaceChild(a,this)}}jQuery(".comments__item").click(function(){$(".video-stream").each(function(a){return $(this).attr("src",$(this).attr("src")),!1})}),$(document).on("click","body",function(){jQuery("iframe").each(function(){jQuery(this)[0].contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})})});